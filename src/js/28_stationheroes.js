...
//   access    'above' (concourse over the platforms) | 'below' (lobby under the tracks) | 'under' (an underpass through
//             the fill under a station on an embankment) | 'end' (a fare hall at platform level past the bumpers,
//             toward endHall.toward: SFO) | 'bridge' (footbridge/mezzanine
...
const StationHeroes = (() => {
  ...
  const CFG = {
    ...
    MCAR: { layout: 'island', type: 'median', access: 'under', underpass: { floor: 30.4 }, floor: CONC(0xa8a296), grid: 0x8c3f2e, canopy: { style: 'box', len: 95, off: 40, top: 0x3a2a22, under: 0x3a2a22, fascia: 0x3a2a22, span: 'all', posts: { shape: 'rect', col: 0x3a2a22, size: 0.4, spacing: 12, where: 'both' } }, hero: 1 },
    ...
    SHAY: { layout: 'side', type: 'aerial', access: 'under', underpass: { floor: 8.0 }, floor: QUARRY(0x6a3a2a), deck: FLUTE(0xada79b, 0.2), canopy: { style: 'flat', len: 86, off: 22, top: 0x5a4a38, under: 0xc9a14a, underKind: K.WOOD, fascia: 0x5a4a38, posts: { shape: 'rect', col: 0x4a3c2e, size: 0.3, spacing: 7.5, where: 'back' } }, ends: 'L' },
    UCTY: { layout: 'side', type: 'aerial', access: 'under', underpass: { floor: 14.6 }, floor: CONC(0xa09b91), canopy: { style: 'flat', len: 108, top: 0xf1f1ef, under: 0xf4f4f2, fascia: 0xf1f1ef, posts: { shape: 'rect', col: 0xe8c21a, size: 0.3, spacing: 9, where: 'back' } }, ends: 'beam' },
    FRMT: { layout: 'island', type: 'aerial', access: 'under', underpass: { floor: 18.5 }, floor: CONC(0x9d988e), bands: 0x8c4a33, canopy: { style: 'shed', len: 91, off: 15, top: 0xb4502e, under: 0x5a3a2a, fascia: 0xc0552e, posts: { shape: 'rect', col: 0x6f7377, size: 0.35, spacing: 9, where: 'centre' } }, ends: 'pergola' },
    WARM: { layout: 'island', type: 'surface', access: 'bridge', floor: GRAN(0x9e9c97, 0.9), canopy: { style: 'flat', len: 132, top: 0x2d3a4c, under: 0xc79a58, underKind: K.WOOD, fascia: 0xf2f2f0, posts: { shape: 'round', col: 0x9c9a95, size: 0.9, spacing: 16, where: 'centre', kind: K.CONCRETE } }, bridgeCover: true, solar: true, rotunda: true },
    ...
    LAFY: { layout: 'island', type: 'median', access: 'under', underpass: { floor: 107.2, reach: 38, approach: 5, col: [0x2a5aa8, K.MOSAIC, 0.03], round: true }, floor: CONC(0xa7a197), canopy: { style: 'flat', len: 80, top: 0x4a3a2c, under: 0xb4824a, underKind: K.WOOD, fascia: 0x3e3226, posts: { shape: 'rect', col: 0x4a3a2c, size: 0.3, spacing: 9, where: 'centre' } }, ends: 'poles' },
