...
const StationHeroes = (() => {
  ...
  const CFG = {
    ...
    // ---------------------------------------------------------------- Peninsula and SFO
    SSAN: { layout: 'island', type: 'subway', access: 'above', floor: CONC(0x9c9a95, 2.0), wall: [0xc9ccd0, K.CORRUG, 0.12], wallUp: [0xc9ccd0, K.CORRUG, 0.12], band: 0x6e2432, ceil: [0xdadcdf, K.PANEL, 0.6],
    ...
    // ---------------------------------------------------------------- Oakland core
    WOAK: { layout: 'side', type: 'aerial', access: 'below', floor: CONC(0x9a958c), deck: FLUTE(0xb9b3a7, 0.1), canopy: { style: 'hipped', len: 100, top: 0x1f7f86, under: 0x2a8d94, fascia: 0x1f7f86, posts: { shape: 'rect', col: 0x1f7f86, size: 0.3, spacing: 9, where: 'back' } },
