...
const AIRCRAFT = (() => {
  ...
  const list = [
    ...
    { id: 'a320', name: 'Airbus A320neo', short: 'A320', maker: 'Airbus', cat: 'Narrow-body jet',
      ...
      model: {
        kind: 'jet', L: 37.57, nose: 17.3, fus: { d: 3.95, h: 4.14, zc: -0.17, noseLen: 5.6, tailLen: 11.5, tailUp: 1.25 },
        wing: { x: 3.9, y0: 1.9, span: 17.9, c0: 7.0, cK: 3.9, yK: 6.2, c1: 1.5, sweep: 27, dih: 5.1, z: 0.93, t: 0.15, tt: 0.11, twist: -4,
          flap: [2.1, 10.5, 0.3], ail: [11, 15.4, 0.25], spoil: [[3.2, 10.3]], tip: 'sharklet', slats: true, fairings: 3 },
        htail: { x: -13.8, span: 6.25, c0: 3.7, c1: 1.3, sweep: 32, dih: 6, z: -0.87, t: 0.1, elev: 0.3 },
        vtail: { x: -11.8, h: 5.9, c0: 5.9, c1: 2.2, sweep: 36, z: -1.97, t: 0.1, rud: 0.32 },
        engines: [{ type: 'fan', x: 3.2, y: -5.75, z: 1.53, d: 2.37, len: 4.3, pylon: 1.0, fanD: 2.06, style: 'leap' }, { type: 'fan', x: 3.2, y: 5.75, z: 1.53, d: 2.37, len: 4.3, pylon: 1.0, fanD: 2.06, style: 'leap' }],
        gear: { noseX: 11.34, mainX: -1.3, track: 3.8 }, cockpit: { x: 13.9, z: -0.9, y: -0.55, style: 'airbus' },
    ...
    { id: 'b738', name: 'Boeing 737-800', short: '737-800', maker: 'Boeing', cat: 'Narrow-body jet',
      ...
      model: {
        kind: 'jet', L: 39.5, nose: 19.4, fus: { d: 3.76, h: 4.01, zc: -0.2, noseLen: 5.2, tailLen: 11.0, tailUp: 1.3 },
        wing: { x: 4.3, y0: 1.85, span: 17.1, c0: 7.3, cK: 4.0, yK: 5.6, c1: 1.25, sweep: 27, dih: 6, z: 0.75, t: 0.155, tt: 0.11, twist: -3,
        ...
        gear: { noseX: 14.0, mainX: -1.6, track: 2.86, doors: false }, cockpit: { x: 15.4, z: -0.85, y: -0.53, style: 'boeing' },
    ...
    { id: 'b789', name: 'Boeing 787-9 Dreamliner', short: '787-9', maker: 'Boeing', cat: 'Wide-body jet',
      ...
      model: {
        kind: 'jet', L: 62.8, nose: 30.2, fus: { d: 5.77, h: 5.97, zc: -0.25, noseLen: 7.6, tailLen: 16, tailUp: 1.7, smoothNose: true },
        wing: { x: 7.4, y0: 2.8, span: 30.06, c0: 11.8, cK: 6.2, yK: 9.8, c1: 1.6, sweep: 32, dih: 6, z: 1.25, t: 0.14, tt: 0.1, twist: -4,
          flap: [3.0, 17.0, 0.28], ail: [17.5, 25.0, 0.2], spoil: [[4.5, 16.5]], tip: 'raked', slats: true, fairings: 4, flex: 1.8 },
        htail: { x: -22.5, span: 9.8, c0: 5.8, c1: 1.9, sweep: 35, dih: 7, z: -1.25, t: 0.1, elev: 0.3 },
        vtail: { x: -19.8, h: 9.2, c0: 8.8, c1: 3.0, sweep: 40, z: -2.75, t: 0.1, rud: 0.32 },
        ...
        gear: { noseX: 23.1, mainX: -2.5, track: 4.9, bogie: 4 }, cockpit: { x: 26.3, z: -1.35, y: -0.6, style: 'boeing' },
    ...
    { id: 'b744', name: 'Boeing 747-400', short: '747-400', maker: 'Boeing', cat: 'Wide-body jet',
      ...
      model: {
        kind: 'jet', L: 70.6, nose: 33.5, fus: { d: 6.5, h: 6.7, zc: -0.15, noseLen: 9, tailLen: 28, tailUp: 2.0, hump: { x0: 33.5, x1: 10.5, h: 1.35 } },
    ...
    { id: 'a388', name: 'Airbus A380-800', short: 'A380', maker: 'Airbus', cat: 'Wide-body jet',
      ...
      model: {
        kind: 'jet', L: 72.72, nose: 34.5, fus: { d: 7.14, h: 8.41, zc: -0.2, noseLen: 10, tailLen: 21, tailUp: 2.6 },
        wing: { x: 8.8, y0: 3.6, span: 39.9, c0: 17.7, cK: 11.2, yK: 12.6, c1: 4.0, sweep: 33.5, dih: 5.6, z: 2.2, t: 0.14, tt: 0.09, twist: -4,
          flap: [4.2, 25.5, 0.26], ail: [27, 37.5, 0.2], spoil: [[6, 25]], tip: 'fence', slats: true, fairings: 4 },
        htail: { x: -26.8, span: 15.2, c0: 9.6, c1: 3.2, sweep: 35, dih: 7, z: -1.9, t: 0.1, elev: 0.3 },
        ...
        gear: { body6: true }, cockpit: { x: 30.0, z: -0.3, y: -0.6, style: 'airbus' },
    ...
    { id: 'conc', name: 'Aérospatiale/BAC Concorde', short: 'Concorde', maker: 'Aérospatiale / BAC', cat: 'Supersonic',
      ...
      model: {
        kind: 'jet', L: 61.66, nose: 32.7, droop: 5.6, fus: { d: 2.88, h: 3.32, zc: -0.14, noseLen: 9, tailLen: 12, tailUp: 0.5, pointy: true },
        wing: { x: 10.7, y0: 1.44, span: 12.8, c0: 27.7, c1: 3.0, sweep: 63, dih: 0, z: 1.26, t: 0.035, tt: 0.03, twist: 0, cam: 0.012,
          flap: null, ail: [1.8, 12.3, 0.12], elevon: true, spoil: null, tip: 'round', ogee: [[0, 0], [0.12, 0.3], [0.3, 0.58], [0.55, 0.79], [0.8, 0.92], [1, 1]] },
        htail: null,
        vtail: { x: -12.5, h: 5.8, c0: 11.5, c1: 2.4, sweep: 57, z: -1.44, t: 0.045, rud: 0.3, split: true },
        engines: [-5.4, -3.6, 3.6, 5.4].map(y => ({ type: 'jet', x: -13, y, z: 1.96, d: 1.4, nozzle: true, box: [11, 1.75, 1.45] })),
