...
const Traffic = (() => {
  ...
  const TYPES = {
    ...
    AT43: ['b738', 22.7], AT45: ['b738', 22.7], AT72: ['b738', 27.2], AT75: ['b738', 27.2], AT76: ['b738', 27.2], DH8A: ['b738', 22.3], DH8B: ['b738', 22.3], DH8C: ['b738', 25.7], DH8D: ['b738', 32.8], SF34: ['c172', 19.7], B190: ['c172', 17.6],
    ...
    B741: ['b744', 70.6], B742: ['b744', 70.6], B743: ['b744', 70.6], B744: ['b744', 70.6], B748: ['b744', 76.3], B74S: ['b744', 56.3], A388: ['b744', 72.7], A342: ['b744', 59.4], A343: ['b744', 63.7], A345: ['b744', 67.9], A346: ['b744', 75.4], A124: ['b744', 69.1], C5M: ['b744', 75.3], IL76: ['b744', 46.6],
  ...
  const LEN = { a320: 37.57, b738: 39.5, b789: 62.8, b744: 70.6, c172: 8.28, f16: 15.06 };
  ...
  // ---------------------------------------------------------------- drawing
  const CLASSES = ['a320', 'b738', 'b789', 'b744', 'c172', 'f16'];
  function initMeshes() {
    meshes = {};
