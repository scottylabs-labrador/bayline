...
// shot), 35 mm, 0.9 m above the rail, a slow push toward the mouth. (The Tube's Oakland portal: track M2 at s
...
const S_CAM = 32092, S_MOUTH = 32030, LEAD = 5.4, FOV = 32.3;
export default {
  ...
  setup: `async () => { ${cine}; ${metro}; const M = window.__m, B = window.__bayline;
    ...
    window.__P = { c0: at(${S_CAM} + 12, -5.1, 0.95), c1: at(${S_CAM}, -5.1, 0.9), q: at(${S_MOUTH}, -2.3, 2.5) }; __cine.put(window.__P.c0, window.__P.q);
