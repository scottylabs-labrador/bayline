...
// below the driver's, 50 degrees, pitched down 6.5 degrees; 120 fps (the edit averages 4 frames: the lights blur) (TRAINS' look: _metrolook.mjs cabLook, exposure and the screens'
...
const S = 27400, FOV = 50, PITCH = -6.5;
export default {
