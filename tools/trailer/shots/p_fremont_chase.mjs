// P22, night: a drone chase along the Fremont line's aerial south of the Coliseum at full line speed (70 mph), off the
...
export default {
  ...
  setup: `async () => { ${cine}; ${metro}; const M = window.__m, B = window.__bayline, C = __cine;
    ...
    window.__dep = M.pass({ track: 'A1.1', s: ${S} }, { heading: 136, minV: 28 }, 21 * 3600 + 30 * 60, 1.2, { focus: true });
    return window.__dep; }`,
