...
export default {
  ...
  prime: `() => { const B = window.__bayline, F = B.Flight; B.Env.setClock(18 * 3600 + 5 * 60); B.Env.state.weather = 'storm'; if (B.Post) B.Post.debug.ae = false;   /* a storm should stay dark: no eye adaptation */ F.armApproach(); F.cam.set('cockpit', true); F.cam.look.pitch = -0.06; return 1; }`,
};
