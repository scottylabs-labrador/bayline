// a southbound express through Atherton's oaks at speed, the drone low off its flank over the trees, slowly overtaken
import { cine, passClock } from './_lib.mjs';
export default {
  maxDsf: 1.5,     // 4K screenshots of this dense canopy wedge the headless GPU readback
  hash: '#auto&t=10:30&q=ultraplus!&w=clear&at=menlo_park', warm: 45, frames: 270,
  setup: `async () => { ${cine}; const B = window.__bayline; window.__dep = (${passClock})(B.Track.byId.menlo_park.s - 2200, 1, 10 * 3600 + 30 * 60, 2.0, 25); return window.__dep; }`,
