// night: circling the Salesforce Tower's lit crown, the city grid glowing below
...
export default {
  ...
  hash: '#auto&t=21:35&q=ultra&w=clear', warm: 45, frames: 240,
  setup: `async () => { ${cine}; const C = __cine, c = C.ll(${T}, 0); C.put({ x: c.x + 220, y: 380, z: c.z + 120 }, { x: c.x, y: 310, z: c.z }); return 1; }`,
