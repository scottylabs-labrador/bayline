...
rsync -az --partial --stats --exclude "*_test.*" -e "ssh -o BatchMode=yes" "$ROOT/data/pub/v2/$SUB/" "root@$IP:$VOL/v2/$SUB/" | grep -E "Number of files transferred|Total transferred file size" || true
